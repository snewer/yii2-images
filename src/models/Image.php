...
class Image extends ActiveRecord
{
    ...
    public function upload($source, array $options = [], array $withPreviews = [])
    {
        ...
        $path = Yii::$app->{$this->storageComponentName}->getStorageById($this->originalUploadStorageId)->upload(
            $resultSource,
    ...
    private function createPreview($needleWidth, $needleHeight)
    {
        ...
        $path = Yii::$app->{$this->storageComponentName}->getStorageById($this->previewUploadStorageId)->upload($resultSource, 'jpg');
